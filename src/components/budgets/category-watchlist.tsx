      ...
      <CardContent className="space-y-4">
              ...
              <div key={categoryId} className={cn("rounded-xl border p-3 space-y-2", isAlert && "border-amber-400/50 bg-amber-50/30 dark:bg-amber-950/10")}>
                ...
                {pct !== null && (
                  <div className="space-y-1">
                    ...
                    />
                    <p className="text-[10px] text-muted-foreground text-right">{pct.toFixed(0)}% del límite</p>
                  </div>
                )}

                {/* Inline threshold edit */}
                <div className="flex items-center gap-2">
                  <span className="text-[10px] text-muted-foreground shrink-0">Límite mes:</span>
                  <Input
                    type="number"
        ...
        {unwatchedCategories.length > 0 && (
          <div className="border-t pt-3 space-y-2">
            <p className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground">Añadir categoría</p>
