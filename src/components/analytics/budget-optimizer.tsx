...
export function BudgetOptimizer({ expenses }: Props) {
  ...
  return (
    <div className="rounded-2xl border bg-card p-4 space-y-4">
      <div>
        <p className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground">Herramienta</p>
            ...
            return (
              <div key={bucket} className="rounded-xl border bg-muted/20 p-3 space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-muted-foreground">{targetPct}% del ingreso</p>
                    </div>
                  </div>
                  <Button
                    size="sm"
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    <p className="text-[9px] text-muted-foreground uppercase tracking-wide">Recomendado</p>
                  ...
                  <div>
                    <p className="text-[9px] text-muted-foreground uppercase tracking-wide">Diferencia</p>
