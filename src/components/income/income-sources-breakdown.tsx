  ...
  return (
    <div className="rounded-2xl border bg-card p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground">Fuentes de ingreso</p>
          <p className="text-sm font-bold mt-0.5">Desglose anual</p>
        </div>
        <div className="text-right">
          <p className="text-[10px] text-muted-foreground">Total {now.getFullYear()}</p>
