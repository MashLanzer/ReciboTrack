...
export function AuditLogButton({ groupId, expenseId, merchant }: AuditLogButtonProps) {
  const [open, setOpen] = useState(false)
  const { data: log = [], isLoading } = useExpenseAuditLog(open ? groupId : null, open ? expenseId : null)
